...
import fullStackImg from '../assets/full-stack-todo-app.png';
import JSGAME from '../assets/JS-snake-game.png';
import WaterImg from '../assets/water-counter.png';
        ...
        <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4">
          ...
          >
            ...
            <div className="opacity-0 group-hover:opacity-100">
              ...
              <div className="pt-8 text-center">
                <a
                  href="https://markmanongsong.github.io/water-counter/"
                  target="_blank"
                >
                  <button className="text-center rounded-lg px-4 py-3 m-2 bg-white text-gray-700 font-bold text-lg">
                    Demo
          ...
          >
            ...
            <div className="opacity-0 group-hover:opacity-100">
              ...
              <div className="pt-8 text-center">
                <a
                  href="https://markmanongsong.github.io/weather-app/"
                  target="_blank"
                >
                  <button className="text-center rounded-lg px-4 py-3 m-2 bg-white text-gray-700 font-bold text-lg">
                    Demo
          ...
          >
            ...
            <div className="opacity-0 group-hover:opacity-100">
              ...
              <div className="pt-8 text-center">
                <a
                  href="https://todo-app-markmanongsong.herokuapp.com/"
                  target="_blank"
                >
                  <button className="text-center rounded-lg px-4 py-3 m-2 bg-white text-gray-700 font-bold text-lg">
                    Demo
                ...
                <a
                  href="https://github.com/markmanongsong/Todo_app_fullstack"
                  target="_black"
                >
                  <button className="text-center rounded-lg px-4 py-3 m-2 bg-white text-gray-700 font-bold text-lg">
                    Code
          ...
          >
            ...
            <div className="opacity-0 group-hover:opacity-100">
              ...
              <div className="pt-8 text-center">
                <a
                  href="https://markmanongsong.github.io/ecommerce-app"
                  target="_blank"
                >
                  <button className="text-center rounded-lg px-4 py-3 m-2 bg-white text-gray-700 font-bold text-lg">
                    Demo
                ...
                <a
                  href="https://github.com/markmanongsong/Ecommerce_app"
                  target="_blank"
                >
                  <button className="text-center rounded-lg px-4 py-3 m-2 bg-white text-gray-700 font-bold text-lg">
                    Code
          ...
          <div
            style={{ backgroundImage: `url(${Chappy})` }}
            className="shadow-lg shadow-[#040c16] group container rounded-md flex justify-center items-center mx-auto content-div"
          >
            {/* Hover Effects */}
            <div className="opacity-0 group-hover:opacity-100">
